...
<template>
  <div>
    <form id="pedido-form" @submit="criarPedido($event)">
      ...
      <div class="inputs">
        <label>Selecione Ponto da carne</label>
      ...
      <div class="inputs">
        ...
        <div class="checkbox-container" id="checkbox-container" v-for="bebida in listBebidas" :key="bebida.id">
          <input 
          type="checkbox" 
          :name="bebida.nome" 
          :value="bebida"
...
export default {
  ...
  methods:{
    ...
    async getOpcionais() {
        ...
        this.listBebidas = dados.bebidas;
    },
    async criarPedido(e) {

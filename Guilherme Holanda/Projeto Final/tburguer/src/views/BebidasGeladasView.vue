<template>
  <div>
    ...
    <div id="scroll-horizontal">
      <div id="card-content" v-for="item in listaBebidasGeladas" :key="item.id">
        <div id="card-linha">
          <div class="foto-item">
...
export default {
  ...
  methods: {
    async consultarMenu() {
      const response = await fetch(`${this.$apiUrl}/menu_bebidas_geladas`);
      const dados = await response.json();
      this.listaBebidasGeladas = dados;
    },
